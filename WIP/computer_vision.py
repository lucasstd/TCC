...
class ComputerVisionCapture:
    ...
    def clean_image_noises(self, img):
        ...
        blurred_image = cv2.GaussianBlur(img, (3, 3), cv2.BORDER_DEFAULT)
    ...
    def read_camera(self):
        ...
        while True:
            ...
            blurred_image = self.clean_image_noises(rescaled_image)
            ...
            self.draw_notes_name(rescaled_image, contours)

            if not contours: continue

            cv2.drawContours(rescaled_image, contours, -1, (0,0,255), 2)
